...
inline fn Uint32* ALIGN_WORD(void * ptr) -> u32
{
  return (Uint32*)(((UintPtr(ptr) + 3) >> 2) << 2);
}

inline const Uint32* ALIGN_WORD(const void* ptr) -> u32
{
  return (Uint32*)(((UintPtr(ptr) + 3) >> 2) << 2);
}
...
impl Dbtup for SimulatedBlock {
friend class DbtupProxy;
friend class Suma;

pub struct KeyReqStruct;
struct KeyReqStruct; // CC
...
private:
  ...
  let m_lqh_block: u32;
  let m_tux_block: u32;
  let m_backup_block: u32;

  pub let m_is_query_block: bool;
  pub let m_is_in_query_thread: bool;
  /**
...
struct Fragoperrec {
  ...
  attributeCount: u32;
   charsetIndex: u32;
   m_null_bits[2]: u32;
   m_extra_row_gci_bits: u32;
   m_extra_row_author_bits: u32;
  union {
  ...
  m_senderData: u32;
  m_restoredLcpId: u32;
  m_restoredLocalLcpId: u32;
  m_maxGciCompleted: u32;
  inUse: bool;
  definingFragment: bool;
};
typedef Ptr<Fragoperrec> FragoperrecPtr;
  ...
  struct AlterTabOperation {
    ...
    tabDesOffset[7]: u32;
    tableDescriptor: u32;
    dynTabDesOffset[3]: u32;
    dynTableDescriptor: u32;
  };
  ...
  struct ScanPos {
    ...
    m_get: Get;                  // entry point in scanNext
     m_key: Local_key;            // scan position pointer MM or DD
     m_page: Page*;               // scanned MM or DD (cache) page
     m_key_mm: Local_key;         // MM local key returned
    m_realpid_mm: u32;        // MM real page id
    m_extent_info_ptr_i: u32;
    m_next_small_area_check_idx: u32;
    m_next_large_area_check_idx: u32;
    m_all_rows: bool;
    m_lcp_scan_changed_rows_page: bool;
    m_is_last_lcp_state_D: bool;
    ScanPos() {
      /*
